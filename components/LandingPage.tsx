...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-amber-50 to-neutral-200 relative overflow-x-hidden">
      ...
      {/* Radial Gradient Accents - contained within viewport */}
      <div className="absolute top-40 left-4 md:left-20 w-80 md:w-96 h-80 md:h-96 bg-amber-200/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-40 right-4 md:right-20 w-80 md:w-96 h-80 md:h-96 bg-stone-300/20 rounded-full blur-3xl"></div>
