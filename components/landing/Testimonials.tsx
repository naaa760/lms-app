...
const Testimonials = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-amber-100 via-orange-200 to-yellow-300 relative">
      {/* Grid Background */}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-xl text-center border border-white/20">
            <div className="w-20 h-20 bg-gray-900 rounded-2xl mx-auto mb-8 flex items-center justify-center">
              <span className="text-white text-2xl font-bold font-serif">CL</span>
            </div>
            
            <div className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto font-light">
              Our dynamic educational platform offers you the tools and resources to
              propel yourself towards a brighter future. With expert guidance &
              a supportive community,
            </div>
            
            <div className="mt-8">
              <div className="text-xl font-semibold text-gray-900 font-serif">CodeLine</div>
            </div>
          </div>
        </div>
      </div>
