...
"[project]/node_modules/@sentry/nextjs/build/cjs/config/util.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/config/webpackPluginOptions.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
const chalk = __turbopack_context__.r("[project]/node_modules/@sentry/nextjs/node_modules/chalk/source/index.js [instrumentation] (ecmascript)");
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
const path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
const resolve = __turbopack_context__.r("[project]/node_modules/@sentry/nextjs/node_modules/resolve/index.js [instrumentation] (ecmascript)");
...
const webpackPluginOptions = __turbopack_context__.r("[project]/node_modules/@sentry/nextjs/build/cjs/config/webpackPluginOptions.js [instrumentation] (ecmascript)");
 ...
 */ function constructWebpackConfigFunction(userNextConfig = {}, userSentryOptions = {}, releaseName) {
            ...
            if (sentryWebpackPlugin) {
                if (!userSentryOptions.sourcemaps?.disable) {
                    ...
                    if (!newConfig.devtool) {
                        core.logger.info(`[@sentry/nextjs] Automatically enabling source map generation for ${runtime} build.`);
                    ...
                    if (!isServer && userSentryOptions.sourcemaps?.deleteSourcemapsAfterUpload === undefined) {
                        core.logger.warn('[@sentry/nextjs] Source maps will be automatically deleted after being uploaded to Sentry. If you want to keep the source maps, set the `sourcemaps.deleteSourcemapsAfterUpload` option to false in `withSentryConfig()`. If you do not want to generate and upload sourcemaps at all, set the `sourcemaps.disable` option to true.');
...
function addValueInjectionLoader(newConfig, userNextConfig, userSentryOptions, buildContext, releaseName) {
    const assetPrefix = userNextConfig.assetPrefix || userNextConfig.basePath || '';
    const isomorphicValues = {
        // `rewritesTunnel` set by the user in Next.js config
        _sentryRewritesTunnelPath: userSentryOptions.tunnelRoute !== undefined && userNextConfig.output !== 'export' ? `${userNextConfig.basePath ?? ''}${userSentryOptions.tunnelRoute}` : undefined,
        ...
        SENTRY_RELEASE: releaseName && !buildContext.dev ? {
            id: releaseName
        } : undefined,
...
"[project]/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
function getFinalConfigObject(incomingUserNextConfigObject, userSentryOptions) {
    const releaseName = userSentryOptions.release?.name ?? node.getSentryRelease() ?? getGitRevision();
    ...
    if (instrumentationClientFileContents !== undefined && !instrumentationClientFileContents.includes('onRouterTransitionStart')) {
        // eslint-disable-next-line no-console
    ...
    if (nextJsVersion) {
        ...
        if (!supportsClientInstrumentation && ("TURBOPACK compile-time value", true)) {
    ...
    return {
        ...
        webpack: webpack.constructWebpackConfigFunction(incomingUserNextConfigObject, userSentryOptions, releaseName)
    };
}
/**
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ async function devErrorSymbolicationEventProcessor(event, hint) {
    ...
    try {
        if (hint.originalException && hint.originalException instanceof Error && hint.originalException.stack) {
            ...
            const parsedNextjsVersion = ("TURBOPACK compile-time truthy", 1) ? core.parseSemver(nextjsVersion) : ("TURBOPACK unreachable", undefined);
            let resolvedFrames;
...
async function resolveStackFrame(frame, error) {
    try {
        ...
        const res = await core.suppressTracing(()=>fetch(`${// eslint-disable-next-line no-restricted-globals
            ("TURBOPACK compile-time truthy", 1) ? 'http://localhost:3000' : ("TURBOPACK unreachable", undefined) // TODO: handle the case where users define a different port
        ...
        debugBuild.DEBUG_BUILD && core.logger.error('Failed to symbolicate event with Next.js dev server', e);
        return null;
    }
}
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
function wrapRouteHandlerWithSentry(routeHandler, context) {
    ...
    return new Proxy(routeHandler, {
        apply: async (originalFunction, thisArg, args)=>{
            ...
            return core.withIsolationScope(("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : core.getIsolationScope(), ()=>{
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/server/index.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/index.server.js [instrumentation] (ecmascript)": (function(__turbopack_context__) {
...
//# sourceMappingURL=node_modules_%40sentry_nextjs_build_cjs_345e5297._.js.map